...
export default function OrganizerLayout() {
  ...
  // Intercept browser back button on dashboard to prompt Sign Out confirmation
  useEffect(() => {
    const isDashboard = location.pathname === '/organizer' || location.pathname === '/organizer/'
          ...
          <div style={{
            ...
            >
              ...
              <p style={{ fontSize: '0.875rem', color: '#94a3b8', marginBottom: '1.5rem', lineHeight: 1.5 }}>
                Are you sure you want to sign out of your Organizer account? You will need your password to log back in.
              </p>
