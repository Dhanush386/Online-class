...
export default function CourseManagement() {
    ...
    const renderSubmitButtonText = () => {
        ...
        return <><Plus size={18} /> Create Course</>;
    };
    ...
    const renderResourcesContent = () => {
        ...
        if (resources.length === 0) {
            return <p style={{ textAlign: 'center', padding: '2rem', color: 'var(--text-muted)', fontSize: '0.85rem' }}>No materials uploaded yet.</p>;
        }
        return (
    ...
    const renderResourceModal = () => {
        if (!showResourceModal || !currentCourse) return null;
        return (
