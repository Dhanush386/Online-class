...
export function WorkspaceEditor({
    ...
    return (
        <div style={{ flex: 1.5, background: '#1e1e2e', borderRadius: 8, display: 'flex', flexDirection: 'column', border: '1px solid var(--card-border)', overflow: 'hidden' }}>
            <div style={{ height: 40, borderBottom: '1px solid var(--card-border)', display: 'flex', background: '#1e1e2e', padding: '0 4px', alignItems: 'center' }}>
                <div style={{ display: 'flex', height: '100%' }}>
                    {challenge.language === 'html' ? (
                        <>
                            <button onClick={() => setWebTab('html')} style={{ padding: '0 1rem', background: webTab === 'html' ? 'rgba(255,255,255,0.08)' : 'transparent', border: 'none', color: webTab === 'html' ? '#e34c26' : 'var(--text-muted)', fontSize: '0.7rem', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6 }}>
                            ...
                            <button onClick={() => setWebTab('css')} style={{ padding: '0 1rem', background: webTab === 'css' ? 'rgba(255,255,255,0.08)' : 'transparent', border: 'none', color: webTab === 'css' ? '#264de4' : 'var(--text-muted)', fontSize: '0.7rem', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6 }}>
                            ...
                            <button onClick={() => setWebTab('js')} style={{ padding: '0 1rem', background: webTab === 'js' ? 'rgba(255,255,255,0.08)' : 'transparent', border: 'none', color: webTab === 'js' ? '#f0db4f' : 'var(--text-muted)', fontSize: '0.7rem', fontWeight: 800, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6 }}>
                        ...
                        <button style={{ padding: '0 1rem', background: '#1e1e2e', border: 'none', color: '#e2e8f0', fontSize: '0.7rem', fontWeight: 800, cursor: 'default', display: 'flex', alignItems: 'center', gap: 6 }}>
            ...
            <div style={{ height: 48, background: '#1e1e2e', borderTop: '1px solid var(--card-border)', display: 'flex', alignItems: 'center', padding: '0 1rem', gap: '0.85rem' }}>
                ...
                <div style={{ marginLeft: 'auto', display: 'flex', gap: '0.85rem' }}>
                    <button onClick={runCode} disabled={running} style={{ padding: '0.4rem 1.25rem', borderRadius: 6, background: '#1e1e2e', border: '1px solid var(--card-border)', color: '#fff', fontSize: '0.8rem', fontWeight: 700, cursor: 'pointer', display: 'flex', alignItems: 'center', gap: 6 }}>
