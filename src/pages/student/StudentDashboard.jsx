...
import {
  ...
  TrendingUp, Sparkles, ShieldCheck, Play, RefreshCw, BarChart2
} from 'lucide-react'
import { 
...
export default function StudentDashboard() {
  ...
  const loadDashboardAnalytics = async () => {
    ...
    try {
      ...
      const allStudents = leaderboardRes.data || []
  ...
  return (
    <motion.div variants={containerVariants} initial="hidden" animate="visible" style={{ padding: '1rem 0', maxWidth: 1400, margin: '0 auto' }}>
      ...
      {/* Row 1: Core Gamification KPIs */}
      <motion.div variants={itemVariants} style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem', marginBottom: '1.5rem' }}>
        
        <GlassCard tilt3d={true} padding="1.25rem" style={{ display: 'flex', flexDirection: 'column', justifyContent: 'space-between' }}>
      ...
      {/* Row 2: Academic Performance KPIs */}
      ...
      <motion.div variants={itemVariants} style={{ display: 'grid', gridTemplateColumns: isMobile ? '1fr' : '2fr 1fr', gap: '1.5rem', marginBottom: '2rem' }}>
        ...
        <GlassCard tilt3d={true} style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ width: '100%', height: 220, flex: 1 }}>
            <ResponsiveContainer>
